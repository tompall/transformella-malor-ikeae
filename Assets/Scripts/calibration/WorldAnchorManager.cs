...
public class WorldAnchorManager : MonoBehaviour
{
    ...
    public List<WorldAnchor> anchors = new List<WorldAnchor>();

    public List<bool> saveAnchors = new List<bool>();

    private Dictionary<WorldAnchor, bool> anchorDB = new Dictionary<WorldAnchor, bool>();
